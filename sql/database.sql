...
-- Dumping database structure for pg-life
CREATE DATABASE IF NOT EXISTS `pg-life` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `pg-life`;

-- Dumping structure for table pg-life.amenities
...
-- Dumping data for table pg-life.amenities: ~13 rows (approximately)
...
-- Dumping structure for table pg-life.cities
...
-- Dumping data for table pg-life.cities: ~4 rows (approximately)
...
-- Dumping structure for table pg-life.interested_users_properties
...
-- Dumping data for table pg-life.interested_users_properties: ~11 rows (approximately)
...
-- Dumping structure for table pg-life.properties
...
-- Dumping data for table pg-life.properties: ~5 rows (approximately)
...
-- Dumping structure for table pg-life.properties_amenities
...
-- Dumping data for table pg-life.properties_amenities: ~52 rows (approximately)
...
-- Dumping structure for table pg-life.testimonials
...
-- Dumping data for table pg-life.testimonials: ~10 rows (approximately)
...
-- Dumping structure for table pg-life.users
...
-- Dumping data for table pg-life.users: ~4 rows (approximately)
INSERT INTO `users` (`id`, `email`, `password`, `full_name`, `phone`, `gender`, `college_name`) VALUES
	...
	(19, 'sohgon55@gmail.com', '5ad1cfca7d9bfb13d7cd55c1c2f56cfdd12894ea', 'Soham Gon', '8240602561', 'male', 'RCCIIT');
